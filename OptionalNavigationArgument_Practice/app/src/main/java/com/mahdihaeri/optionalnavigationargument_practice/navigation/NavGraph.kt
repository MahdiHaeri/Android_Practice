...
import com.mahdihaeri.optionalnavigationargument_practice.ui.FirstScreen
import com.mahdihaeri.optionalnavigationargument_practice.ui.SecondScreen
...
fun SetupNavHost(
    ...
    NavHost(
        ...
        composable(
            route = ScreenRoute.SecondScreen.route.plus("?firstName={firstName}&").plus("lastName={lastName}"),
            arguments = listOf(
